...
>>>>>>> fc6eaa7b3460ceda1a347b5725a73dd9a4690ec4
            ...
            <form method="POST">
              <div class="mb-3">
                ...
                <input
                  ...
                  type="text"
                  name="nazivIzvora"
                  placeholder="Unesite naziv izvora"
                  :class="{ 'is-invalid': errors.nazivIzvora }"
                />
                <span v-if="errors.nazivIzvora" class="invalid-feedback">{{
                  nazivPoruka
                }}</span>
              </div>
              <div class="mb-3">
                ...
                <input
                  ...
                  type="text"
                  name="opisIzvora"
                  placeholder="Unesite opis izvora"
                  :class="{ 'is-invalid': errors.opisIzvora }"
                />
                <span v-if="errors.opisIzvora" class="invalid-feedback">{{
                  opisPoruka
                }}</span>
              </div>
              <br />
              <div class="mb-3">
                <label class="form-label required">Način Ulaska:</label
                ><br /><br />
                <input
                  ...
                  value="rucno"
                  id="rucno"
                  v-model="selectedNacinUlaska"
                />
                <label class="form-check-label" for="rucno"> Ručni unos </label
                >&emsp;&emsp;
                ...
                <input
                  ...
                  v-model="selectedNacinUlaska"
                />
                <label class="form-check-label" for="automatski">
                  Automatski unos
                </label>
              </div>
              <br />
                ...
                <div class="mb-3">
                  <div class="form-check">
                    <input
                      ...
                      v-model="obradaTLD"
                    />
                    <label class="form-check-label" for="obradaPoTLD"
                      >Obrada po TLD</label
                    >
                  </div>
                </div>
                <div class="mb-3">
                  <div class="form-check">
                    <input
                      ...
                      type="checkbox"
                      id="odbaceniDomeni"
                      v-model="odbaceniDomeni"
                    />
                    <label class="form-check-label" for="odbaceniDomeni"
                      >Obrada po odbačenim domenima</label
                    >
                  </div>
                </div>
                <div class="mb-3">
                  <div class="form-check">
                    <input
                      ...
                      v-model="kljucneReci"
                    />
                    <label class="form-check-label" for="kljucneReci"
                      >Obrada po ključnim recima</label
                    >
                  </div>
                </div>
                <div class="mb-3">
                  <div class="form-check">
                    <input
                      ...
                      type="checkbox"
                      id="odbaceneEmail"
                      v-model="odbaceneEmail"
                    />
                    <label class="form-check-label" for="odbaceneEmail"
                      >Odbačene email adrese</label
                    >
                  </div>
                </div>
              </div>
              ...
              <div v-if="selectedNacinUlaska === 'automatski'">
                ...
                <div class="mb-3">
                  ...
                  <input
                    ...
                    :class="{ 'is-invalid': errors.apiRuta }"
                  />
                  <span v-if="errors.apiRuta" class="invalid-feedback">{{
                    apiPoruka
                  }}</span>
                </div>
                <div class="mb-3">
                  <label class="form-label required"
                    >Interval automatskog unosa (u minutima):</label
                  >
                  <input
                    class="form-control"
                    v-model="intervalUnosa"
                    type="text"
                    name="intervalUnosa"
                    min="1"
                    :class="{ 'is-invalid': errors.intervalUnosa }"
                    v-numericOnly
                  />
                  <span v-if="errors.intervalUnosa" class="invalid-feedback">{{
                    poruka
                  }}</span>
                </div>
                <div class="mb-3">
                  <label class="form-label"
                    >Datum do kada se vrši automatski unos:</label
                  >
                  <date-picker
                    v-model="datumUnosa"
                    format="DD.MM.YYYY."
                  ...
                  <small class="form-text text-muted"
                    >Napomena: Ako je polje prazno, automatski unos nema
                    kraj.</small
                  >
                </div>
    ...
    <div class="row mt-3 mb-3">
      ...
      <div class="col-6">
        <button
          @click="errorsClean"
          type="button"
          class="btn btn-primary col-4 float-end"
          data-bs-toggle="modal"
          data-bs-target="#createIzvor"
        >
          Kreirajte Izvor
        </button>
      </div>
      ...
      <div class="card card-body">
        <div class="row">
          <div class="col-3">
            ...
            ><br />
            <date-picker
              v-model="datumObradeFilter"
              format="DD.MM.YYYY."
              @change="izvorDataTable"
            ></date-picker>
          </div>
          <div class="col-3">
        ...
        <div class="row">
          <div class="my-3 d-grid gap-2 d-flex justify-content-end">
            <button
              @click="clearFilter"
              type="button"
              class="btn btn-primary col-2 float-end"
            >
              Resetujte Filtere
            </button>
          </div>
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <table
          class="display responsive table table-bordered table-striped pt-2"
          width="100%"
          id="izvorTabela"
        >
          <thead>
            ...
            <form method="POST">
              ...
              <div class="mb-3">
                ...
                <input
                  ...
                  type="text"
                  name="nazivIzmeni"
                  :class="{ 'is-invalid': errors.nazivIzmeni }"
                />
                <span v-if="errors.nazivIzmeni" class="invalid-feedback">{{
                  nazivIzmeniPoruka
                }}</span>
              </div>
              <!-- Radio nacin ulaska-->
              <div class="mb-3">
                ...
                <input
                  class="form-check-input"
                  type="radio"
                  name="nacinUlaskaIzmena"
                  value="rucno"
                  id="rucnoIzmena"
                  v-model="selectedNacinUlaskaIzmena"
                />
                <label class="form-check-label" for="rucnoIzmena">
                  Ručni unos </label
                >&emsp;&emsp;
                ...
                <input
                  ...
                  v-model="selectedNacinUlaskaIzmena"
                />
                <label class="form-check-label" for="automatskiIzmena">
                  Automatski unos
                </label>
              </div>
              <br />
                ...
                <div class="mb-3">
                  <div class="form-check">
                    <input
                      ...
                      type="checkbox"
                      id="obradaTLDIzmena"
                      v-model="obradaTLDIzmena"
                    />
                    <label class="form-check-label" for="obradaTLDIzmena"
                      >Obrada po TLD</label
                    >
                  </div>
                </div>
                <div class="mb-3">
                  <div class="form-check">
                    <input
                      class="form-check-input"
                      type="checkbox"
                      id="odbaceniDomeniIzmena"
                      v-model="odbaceniDomeniIzmena"
                    />
                    <label class="form-check-label" for="odbaceniDomeniIzmena"
                      >Obrada po odbačenim domenima</label
                    >
                  </div>
                </div>
                <div class="mb-3">
                  <div class="form-check">
                    <input
                      class="form-check-input"
                      type="checkbox"
                      id="kljucneReciIzmena"
                      v-model="kljucneReciIzmena"
                    />
                    <label class="form-check-label" for="kljucneReciIzmena"
                      >Obrada po ključnim recima</label
                    >
                  </div>
                </div>
                <div class="mb-3">
                  <div class="form-check">
                    <input
                      class="form-check-input"
                      type="checkbox"
                      id="odbaceneEmailIzmena"
                      v-model="odbaceneEmailIzmena"
                    />
                    <label class="form-check-label" for="odbaceneEmailIzmena"
                      >Odbačene email adrese</label
                    >
                  </div>
                </div>
              ...
              <div v-if="selectedNacinUlaskaIzmena === 'automatski'">
                ...
                <div class="mb-3">
                  ...
                  />
                  <span v-if="errors.apiRutaIzmena" class="invalid-feedback">{{
                    apiPorukaIzmena
                  }}</span>
                </div>
                <div class="mb-3">
                  ...
                  <input
                    class="form-control"
                    v-model="intervalUnosaIzmena"
                    type="text"
                    name="intervalUnosaIzmena"
                    min="1"
                    :class="{ 'is-invalid': errors.intervalUnosaIzmena }"
                    v-numericOnly
                  />
                  <span
                    v-if="errors.intervalUnosaIzmena"
                    class="invalid-feedback"
                    >{{ intervalIzmenaPoruka }}</span
                  >
                </div>
                <div class="mb-3">
                  <label class="form-label"
            ...
            <div class="mb-3">
              ...
              <div class="form-check">
                <input
                  ...
                  v-model="selectArhiviraj"
                />
                <label class="form-check-label" for="dearhiviraj">
                  Dearhiviraj
                </label>
              </div>
            </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body m-2">
            <div class="mb-3">
              <h5>
                Ukupno adresa vezano za izvor:
                <b>{{ this.numberOfSourcesInIzvori }}</b>
              </h5>
              <br />
            </div>

            <label class="form-label required"
              >Izaberite oblik izvoza e-mail adresa:
            </label>
            <div class="mb-3">
              <div class="form-check">
                <input
                  ...
                  <div class="mb-3">
                    <div class="form-check">
                      <input
                        ...
                        v-model="addressesId"
                      />
                      <label class="form-check-label" for="addressesId"
                        >ID</label
                      >
                    </div>
                  </div>
                  ...
                  <div class="mb-3">
                    <div class="form-check">
                      <input
                        ...
                        v-model="inputDate"
                      />
                      <label class="form-check-label" for="inputDate"
                        >Datum Unosa</label
                      >
                    </div>
                  </div>
          ...
          <div class="modal-footer">
            ...
            <button @click="exportIzvor" type="button" class="btn btn-primary">
              Izvezite
            </button>
          </div>
        </div>
  ...
  methods: {
    ...
    dodajIzvor() {
      ...
      if (this.selectedNacinUlaska === "automatski") {
        ...
        const regexAPI =
          /^(http(s)?:\/\/(www.)?[a-z]{1,20}(\.[a-z]{1,20})?\.[a-z]{2,6}(\/)?([a-z]{1,20})?)*$/;
      ...
      $(document).on("click", ".izmeniAkcija", function (e) {
        ...
        axios
          ...
          .then((response) => {
            ...
            th.selectedNacinUlaskaIzmena =
              response.data.selectedData[0].nacinUlaska;
            if (response.data.selectedData[0].nacinUlaska === "Ručno") {
              document.getElementById("rucnoIzmena").checked = true;
            } else if (
              response.data.selectedData[0].nacinUlaska === "Automatski"
            ) {
              document.getElementById("automatskiIzmena").checked = true;
            }
            th.obradaTLDIzmena = response.data.selectedData[0].obrada_po_tld;
            th.odbaceniDomeniIzmena =
              response.data.selectedData[0].obrada_po_odbacenim_domenima;
            th.kljucneReciIzmena =
              response.data.selectedData[0].obrada_po_kljucnim_recima;
            th.odbaceneEmailIzmena =
              response.data.selectedData[0].odbacene_email_adrese;
            th.apiRutaIzmena = response.data.selectedData[0].apiRuta;
            th.intervalUnosaIzmena =
              response.data.selectedData[0].interval_unosa;
            th.datumUnosaIzmena = response.data.selectedData[0].datum_unosa
              ? new Date(response.data.selectedData[0].datum_unosa)
              : null;
          })
          .catch((error) => {
            if (error.response.status == 401 || error.response.status == 419) {
    ...
    izmeniIzvor() {
      ...
      if (this.selectedNacinUlaskaIzmena === "automatski") {
        ...
        if (!regex.test(this.intervalUnosaIzmena)) {
          ...
          this.intervalIzmenaPoruka =
            "Interval unosa ne sme počinjati sa nulom.";
          return;
        }
      }
        ...
        axios
          ...
          .then((response) => {
            ...
            if (response.data.selectedData[0].arhiviraj === "Arhiviraj") {
              ...
              response.data.selectedData[0].arhiviraj === "Dearhiviraj"
            ) {
    ...
    numberOfSourcesForExport() {
      ...
      $(document).on("click", ".izvozAkcija", function (e) {
        ...
        axios
          .post(
            "/administracija-grupa/izvoriExport/numberOfSourcesInIzvori",
            podaci,
            {
              headers: {
                "X-CSRF-TOKEN": csrfToken,
    ...
    exportIzvor() {
      ...
      if (this.selectExportType == "txt") {
        axios
          .post(
            "/administracija-grupa/izvoriTxtExport",
            { izvorID: th.izvorID, groupID: th.id },
            {}
          )
          .then((response) => {
            modal.modal("hide");
        ...
        columns: [
          { data: "izvorID" },
          {
            ...
            render: function (data, type, row) {
              return (
                '<a type="button" class="link-primary" href="/administracija-grupa/izvor/' +
                th.id +
                "/addresses/" +
                row.izvorID +
                '">' +
          ...
          },
          {
            ...
            render: function (data, type, row) {
              if (
                th.user_privilege["role"] == "admin" ||
                th.user_privilege["source_export_privilege"] == 1
              ) {
                return (
                  '<div class="dropdown">' +
